...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/rebuild_data.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'data/exp45/weights/last.pt', help='model path(s)')
