...
def parameters():
    ...
    # GPIO参数
    parser.add_argument("--localPath",default ="/home/tzx/GPIO/Raspberry/run/input_capture_video")
    ...
    # 相机标定参数
    parser.add_argument("--npz",default='/home/tzx/GPIO/Raspberry/code/data.npz')
    # 图像拍摄
    parser.add_argument("--input_capture_video",default="/home/tzx/GPIO/Raspberry/run/input_capture_video")# Capture_video参数
    # 压缩文件
    parser.add_argument("--dirpath",default="/home/tzx/GPIO/Raspberry/run/input_capture_video")
    parser.add_argument("--outFullName",default="/home/tzx/GPIO/Raspberry/run/Capture.zip ")
    #发送文件
    ...
    parser.add_argument("--zipFile",default="/home/tzx/GPIO/Raspberry/run/Capture.zip")#附件
