...
def parameters():
    ...
    # GPIO参数
    parser.add_argument("--localPath",default="D:\Graduation_Project_Coding\pythonProject\Raspberry\\run/input_capture_video")
    ...
    # 压缩文件
    parser.add_argument("--dirpath",default="D:\Graduation_Project_Coding\pythonProject\Raspberry/run\input_capture_video")
    parser.add_argument("--outFullName",default="D:\Graduation_Project_Coding\pythonProject\Raspberry/run\Capture.zip ")
    #发送文件
    ...
    parser.add_argument("--zipFile",default="D:\Graduation_Project_Coding\pythonProject\Raspberry/run\Capture.zip")#附件
