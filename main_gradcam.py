...
from yolov5_object_detector import YOLOV5TorchObjectDetector
import cv2
# 数据集类别名
...
names = ['Thyroid_DoubleenedRetractor_middlesize',
         'TissueForceps_14cm',
         'Appendix_IntestinalClamp_16cm',
         'SRestractor_25cm',
         'straight_OvalForceps',
         'elbow_OvalForceps',
         'MedicalTray_18.5cm',
         'TowelForceps_11cm',
         'straight_LigatureScissors_10cm',
         'elbow_LigatureScissors_10cm',
         'straight_LigatureScissors_18cm',
         'elbow_LigatureScissors_16cm',
         'Tweezers_ST_10',
         'Tweezers_ST_11',
         'Tweezers_ST_12',
         'Tweezers_ST_13',
         ...
         'thick_Scalpel_4',
         'thin_Scalpel_4',
         'elbow_HemostasticForceps_12.5cm',
         'straight_HemostasticForceps_14cm']
# yolov5s网络中的三个detect层
target_layers0 = ['model_27_m_0']
target_layers1 = ['model_27_m_1']
target_layers2 = ['model_27_m_2']
target_layers = ['model_27_m_0','model_27_m_1','model_27_m_2']

# Arguments
parser = argparse.ArgumentParser()
parser.add_argument('--model-path', type=str, default="a/sam.pt", help='Path to the model')
parser.add_argument('--img-path', type=str, default='data/testval/', help='input image path')
parser.add_argument('--output-dir', type=str, default='runs/result/5-sam/', help='output dir')
parser.add_argument('--img-size', type=int, default=640, help="input image size")
parser.add_argument('--target-layer', type=str, default='model_17_cv3_act',
                    help='The layer hierarchical address to which gradcam will applied,'
                         ' the names should be separated by underline')
parser.add_argument('--method', type=str, default='gradcam', help='gradcam /gradcampp method')
...
def main(img_path):
    ...
    # print(model)
    # model = DetectMultiBackend(args.model_path, device=device, dnn=dnn, data=data, fp16=half)
    # img[..., ::-1]: BGR --> RGB
    # (480, 640, 3) --> (1, 3, 480, 640)
    torch_img = model.preprocessing(img[..., ::-1])
    tic = time.time()
    # 遍历三层检测层
    for target_layer in target_layers2:
        # 获取grad-cam方法
        ...
        for i, mask in enumerate(masks):
            ...
            # output_path = f'{target_layer[6:8]}_1.jpg'
