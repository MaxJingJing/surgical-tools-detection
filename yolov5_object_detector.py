...
# import sys
# sys.path.append( "D:\Graduation_Project_Coding\\network_classify\yolov5-7.0 -first\models")
...
class YOLOV5TorchObjectDetector(nn.Module):
    def __init__(self,
        ...
        self.model = attempt_load(model_weight, inplace=False, fuse=True)
    ...
    @staticmethod
    def non_max_suppression(prediction, logits, conf_thres=0.1, iou_thres=0.9, classes=None, agnostic=False,
    ...
    def forward(self, img):
        ...
        # print('hahahah',prediction.shape)
        # print('这是什么啊',logits.shape)
        # print('zhege ne ',len(_))
